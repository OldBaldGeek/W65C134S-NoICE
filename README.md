...
Failing discovery of clay tablets documenting that format it is possible to generate
a text file containing symbol definitions and line-number information. I may eventually
write a Python script to extract this information. If you beat me to it, I would be
happy to include your program here.
